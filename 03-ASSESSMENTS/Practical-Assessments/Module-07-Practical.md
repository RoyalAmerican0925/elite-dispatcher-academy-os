# Module 07 Practical Assessment — Load Evaluation Desk
...
1. Completed Calculation Worksheet entries for all three loads (or equivalent shown work).
2. A completed Load-Comparison Worksheet showing loaded RPM, effective RPM, and estimated contribution margin for all three.
3. A written recommendation memo (150–300 words) that:
   - States your recommended load.
